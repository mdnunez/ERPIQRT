# JAGS_OOS2_Mediation.py - Performs out-of-sample prediction of new data using
...
model {
  ...
  for(i in 1:N) {
    ...
    IQ_mu_eta[m,i] <- beta[m,2]*v_eta[m,i,1] + beta[m,3]*ERP_eta[m,i,1]
    ...
    v_mu_eta[m,i,1] <- beta[m,1]*ERP_eta[m,i,1]
...
for t in range(0,10):
  ...
  # Model name
  modelname = 'OOS2_%s_Mediation_%s'
