...
noIQsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noIQ_noMediation_May_*.mat');
noERPsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noERP_noMediation_May_*.mat');
noRTsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noAccRT_noMediation_May_*.mat');
...
RTre = ysim;
ERPdata = ERPsim;
saveit = '../Results/Eval_noMed_OOS.mat';
fprintf('Saving %s ...\n',saveit);
