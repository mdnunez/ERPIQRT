%OOS_noMediation.m   Evaluated out-of-sample prediction
...
noIQsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noIQ_noMediation_Mar_*.mat');
noERPsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noERP_noMediation_Mar_*.mat');
noRTsamps = rdir('/home/michael/data10/michael/intel/jagsout/behavmodel_OOS2_noAccRT_noMediation_Mar_*.mat');
...
RTre = ysim;
ERPdata = ERPsim;
saveit = '/home/michael/data10/michael/intel/jagsout/Eval_noMed_OOS.mat';
fprintf('Saving %s ...\n',saveit);
