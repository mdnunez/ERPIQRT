...
load('~/data10/michael/intel/Results/Joint_Mediation.mat');
...
if exist('../../final_results/Eval_Med_IS.mat') ~= 2
    rng(13);
    for i = 1:N
        for k = 1:6
    ...
    RTre = RTre';
    save('Eval_Med_IS.mat','IQ','RTdata','ACCdata','RTre','ERPdata');
else
    fprintf('Loading found simulated data...\n');
    load('../../final_results/Eval_Med_IS.mat');
end
