...
%JointCFA_Mediation_P3.m     Contains all three CFAs (IQ, ERP, Diffusion
...
'    IQ.mu.eta[i] <- beta[1]*ERP.eta[i,1] + beta[2]*ERP.eta[i,4] + beta[3]*v.eta[i,1]'
'   '
...
'    v.mu.eta[i,1] <- beta[4]*ERP.eta[i,1] + beta[5]*ERP.eta[i,4]'
...
% Starting values (Does the underscore work?)
generator = @()struct(...
...
save('../Results/Joint_Mediation_P3.mat','chains','diagnostics','info','stats')
