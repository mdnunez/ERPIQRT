%JointCFA_noMediation.m     Contains all three CFAs (IQ, ERP, Diffusion
%               model) with a simple linear regression connector between
%               ERP and IQ
%
...
save('../Results/Joint_noMediation.mat','chains','diagnostics','info','stats')
